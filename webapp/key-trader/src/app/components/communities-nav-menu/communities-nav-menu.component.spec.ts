...
import { CommunitiesNavMenuComponent } from './nav-menu.component';

describe('CommunitiesNavMenuComponent', () => {
  let component: CommunitiesNavMenuComponent;
  let fixture: ComponentFixture<CommunitiesNavMenuComponent>;
  let debugElement: DebugElement;
  let router: Router;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [CommunitiesNavMenuComponent],
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CommunitiesNavMenuComponent);
